...
public final class Cache<Key: Hashable, Value>: @unchecked Sendable {
	public struct Configuration {
		...
		public init(costLimit: Int, countLimit: Int, ttl: TimeInterval? = nil, entryCostLimit: Double = 0.1) {
	...
	public init(costLimit: Int, countLimit: Int) {
		self._conf = Configuration(costLimit: costLimit, countLimit: countLimit)
