...
public extension ImagePipeline {
	...
	struct Configuration: @unchecked Sendable {
		...
		public static func withDataCache(name: String = "com.github.kean.Nuke.DataCache",
		                                 sizeLimit: Int? = nil) -> Configuration
		{
	...
	enum DataCachePolicy: Sendable {
		...
		/// data:// URL scheme).
		///
		/// - important: With this policy, the pipeline's
		/// ``ImagePipeline/loadData(with:completion:)-6cwk3``
