...
private extension CGContext {
    static func make(
        _ image: CGImage,
        size: CGSize,
        alphaInfo: CGImageAlphaInfo? = nil
    ) -> CGContext? {
    ...
    private static func preferredAlphaInfo(
        for image: CGImage,
        colorSpace: CGColorSpace
    ) -> CGImageAlphaInfo {
...
private func getMaxPixelSize(
    for source: CGImageSource,
    options thumbnailOptions: ImageRequest.ThumbnailOptions
) -> CGFloat {
