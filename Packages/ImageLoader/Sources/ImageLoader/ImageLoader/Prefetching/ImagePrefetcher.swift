...
public final class ImagePrefetcher {
	...
	public enum Destination: Sendable {
		...
		/// ``ImagePipeline/DataCachePolicy/automatic``
	...
	public nonisolated init(pipeline: ImagePipeline = ImagePipeline.shared,
	...
	private func loadImage(task: PrefetchTask, finish: @escaping () -> Void) {
		let imageTask = pipeline.makeImageTask(
			with: task.request,
			isDataTask: destination == .diskCache
		)
