...
class ChatEngine {
	...
	func respondTo(msgs: [Message],
	               summary: String?) async throws -> ChatEngineMsgGenerable
	{
	...
	func topics(msgs: [Message]) async throws -> [TopicGenerable] {
		let history = makeHistory(msgs: msgs)
		let prompt = """
	...
	func summarize(msgs: [Message],
	               previousSummary: String?) async throws -> String
	{
		let history = makeHistory(msgs: msgs)
...
private extension ChatEngine {
	func buildResponsePrompt(summary: String,
	...
	func buildResponsePrompt(history: String,
	                         lastMessage: String?) -> String
	{
		"""
	...
	func buildSummaryPrompt(history: String,
	...
	func buildIncrementalSummaryPrompt(history: String,
	                                   previousSummary: String) -> String
	{
		"""
	...
	func buildTopicPrompt(history: String) -> String {
		"""
		You will be creating topics of the following conversation.
		Make topic short and precise.
		Make markdown texts if needed.
