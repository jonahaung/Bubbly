...
extension AttachmentDataAPI {
	// MARK: - Cached Image Handling

	fileprivate func getCachedImageData(for message: Message) throws -> Data? {
	...
	fileprivate func processAttachment(_ attachment: Attachment, for message: Message) async throws -> Data {
	...
	fileprivate func processImageAttachment(_ attachment: Attachment, for message: Message) async throws -> Data {
	...
	fileprivate func processVideoAttachment(_: Attachment, for _: Message) async throws -> Data {
	...
	fileprivate func processLinkAttachment(_ attachment: Attachment, for message: Message) async throws -> Data {
	...
	fileprivate func fetchImage(from urlString: String) async throws -> UIImage {
	...
	fileprivate func saveImage(_ uiImage: UIImage, for message: Message) async throws -> Data {
		do {
