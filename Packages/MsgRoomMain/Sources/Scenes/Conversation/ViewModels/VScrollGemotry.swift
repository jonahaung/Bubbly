...
public struct VScrollGeometry: Sendable, Hashable, Equatable {
	...
	public static func == (lhs: Self, rhs: Self) -> Bool {
		lhs.contentHeight == rhs.contentHeight && lhs.offsetY == rhs.offsetY
	}
}
...
extension VScrollGeometry {
	...
	public var location: ScrollLocation {
	...
	public var centerFraction: CGFloat {
...
extension VScrollGeometry {
	public func targetOffsetY(for rect: CGRect) -> CGFloat {
	...
	public func adjustedOffsetY(from oldValue: VScrollGeometry) -> CGFloat {
...
extension ScrolledPosition {
	public init(_ geometry: VScrollGeometry) {
