...
extension MsgCreator {
	// MARK: - Message Building

	fileprivate func createImageMessage(
		image: UIImage,
		text: String,
		urlString: String,
		type: AttachMentType,
	...
	fileprivate func processImageAttachment(
		for message: Message,
	...
	fileprivate func makeOutgoingStatus(
...
extension MsgCreator {
	fileprivate nonisolated static func generateMessageId() -> String {
