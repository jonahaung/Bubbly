...
extension ConversationInitializer {
	public static func createPrefetchedObject(
		conversation: any ConversationRepresentable
...
extension ConversationInitializer {
	public static func start(conID: String, refetch: Bool, delay: Double = 0) {
	...
	public static func start(conversation: any ConversationRepresentable) {
		Task {
			do {
				try await initializeAndPush(conversation: conversation)
			} catch {
	...
	@concurrent
	public static func initializeAndPush(conversation: any ConversationRepresentable) async throws {
