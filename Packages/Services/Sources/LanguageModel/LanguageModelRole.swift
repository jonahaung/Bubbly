...
extension LanguageModelRole: CustomStringConvertible {
	public var description: String {
		switch self {
		case .friend:
			return "For General, High-Quality Conversation"
		case .customerSupport:
			return "For Goal-Oriented Conversations"
		case .coach:
			return "For Goal-Oriented Conversations"
		case .iOSDeveloper:
			return "For Software Development Conversations"
		}
	}
}
extension LanguageModelRole {
