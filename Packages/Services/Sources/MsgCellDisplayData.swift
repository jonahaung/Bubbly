...
extension MsgCellDisplayData {
	public enum ContentDisplay: Conformable {
...
extension MsgCellDisplayData.ContentDisplay {
	public static func create(from msg: Message) -> MsgCellDisplayData.ContentDisplay {
		switch msg.msgKind {
		case .markdown:
