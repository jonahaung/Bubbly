...
final class ColorExtractor {
    ...
    private var distances: UnsafeMutableBufferPointer<Float>! = nil
...
private extension ColorExtractor {
    ...
    func updateCentroids() -> Bool {
        ...
        populateDistances()
        guard let centroidIndices = makeCentroidIndices() else {
            return false
        }
    ...
    private func distanceSquared(
        greenPointer: UnsafePointer<Float>,
        greenValue: Float,
        bluePointer: UnsafePointer<Float>,
        blueValue: Float,
        redPointer: UnsafePointer<Float>,
        redValue: Float,
        count: Int,
