...
public struct NotificationRequest {
	...
	public init(content: NotificationContent,
...
public final class DefaultNotificationService: NotificationService {
	...
	public init(scheduler: NotificationScheduler = UNUserNotificationCenter.current(),
	...
	private func canSchedule(request: NotificationRequest,
	                         settings: UNNotificationSettings) -> Bool
	{
...
public extension NotificationRequest {
	static func immediate(title: String,
	                      body: String,
	                      sound: NotificationSound? = .default,
	                      badge: NSNumber? = nil) -> NotificationRequest
	{
		let content = NotificationContent(
			title: title,
			body: body,
	...
	static func timed(interval: TimeInterval,
	                  title: String,
	                  body: String,
	                  sound: NotificationSound? = .default,
	                  repeats: Bool = false) -> NotificationRequest
	{
		let content = NotificationContent(
			title: title,
			body: body,
