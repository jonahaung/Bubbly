...
public extension Crypto {
	...
	static func generateSymmetricKeyBetween(_ privateKey: Curve25519.KeyAgreement.PrivateKey,
	                                        and publicKey: Curve25519.KeyAgreement.PublicKey,
	                                        salt: Data = generateSalt()) -> SymmetricKey?
	{
	...
	static func decrypt(encryptedData: Data,
...
private extension Crypto {
	static func generateSecretBetween(_ privateKey: Curve25519.KeyAgreement.PrivateKey,
