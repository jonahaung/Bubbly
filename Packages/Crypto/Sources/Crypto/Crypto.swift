...
public extension Crypto {
	...
	static func generateSymmetricKeyBetween(
		...
		guard let sharedSecret = generateSecretBetween(privateKey, and: publicKey) else { return nil }
...
public extension Crypto {
	...
	guard let data = Data(base64Encoded: base64String),
		  let publicKey = try? Curve25519.KeyAgreement.PublicKey(rawRepresentation: data) else {
			return nil
		}
		return publicKey
	}
