...
public final class FirestoreRESTClient {
	...
	public init(projectId: String = AppInformation.firebaseProjectID, database: String = "(default)") {
		...
		self.baseURL = "https://firestore.googleapis.com/v1/projects/\(projectId)/databases/\(database)/documents"
	...
	public func getDocument<T: Codable>(at path: String, as type: T.Type) async throws -> T {
