...
public protocol SwiftLinkPreviewType {
	func preview(_ text: String,
	             ...
	             onError: @escaping (SwiftLinkPreviewError) -> Void) -> CancellableType
	...
	func previewLink(_ text: String,
	                 onSuccess: @escaping ([String: Any]) -> Void,
	                 onError: @escaping (NSError) -> Void) -> CancellableType
	func crawlMetaTags(_ htmlCode: String, result: SwiftLinkPreviewResponse)
		-> SwiftLinkPreviewResponse
	func crawlImages(_ htmlCode: String, result: SwiftLinkPreviewResponse)
		-> SwiftLinkPreviewResponse
	...
	func crawlDescription(_ htmlCode: String, result: SwiftLinkPreviewResponse)
		-> (htmlCode: String, result: SwiftLinkPreviewResponse)
	func crawlTitle(_ htmlCode: String, result: SwiftLinkPreviewResponse)
		-> (htmlCode: String, result: SwiftLinkPreviewResponse)
	func crawlMetaBase(_ htmlCode: String, result: SwiftLinkPreviewResponse)
		-> SwiftLinkPreviewResponse
