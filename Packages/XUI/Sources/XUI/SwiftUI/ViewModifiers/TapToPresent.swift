...
public extension View {
	func presentSheet(@ViewBuilder content: @escaping () -> some View,
	                  onDismiss: sending (() -> Void)? = nil) -> some View
	{
		ModifiedContent(
			content: self,
	...
	func presentFullScreen(@ViewBuilder content: @escaping () -> some View,
	                       onDismiss: sending (() -> Void)? = nil) -> some View
	{
		ModifiedContent(
			content: self,
	...
	func sheetWithZoomTransition(id: String = UUID().uuidString,
