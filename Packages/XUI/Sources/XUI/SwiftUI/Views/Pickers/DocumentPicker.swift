...
public struct DocumentPicker: UIViewControllerRepresentable {
	...
	/// - Parameter fileContent: A binding to a property that stores the contents of the selected
	/// file.
	...
	/// Creates and returns a document picker that can export or copy the types of documents you
	/// specify.
	/// - Parameter fileContent: A binding to a property that stores the contents of the selected
	/// file.
	/// - Parameter urls: An array of documents that the document picker exports or copies.
	/// - Parameter asCopy: A Boolean value that indicates whether the document picker copies the
	/// selected document.
	...
	/// - Parameter fileContent: A binding to a property that stores the contents of the selected
	/// file.
	/// - Parameter contentTypes: An array of uniform type identifiers for the document picker to
	/// display.
	///   For more information, see [Uniform Type
	/// Identifiers](https://developer.apple.com/documentation/uniformtypeidentifiers).
	public init(fileContent: Binding<String>,
	            forOpeningContentTypes contentTypes: [UTType] = [.data])
	{
		self.init(fileContent: fileContent, forOpeningContentTypes: contentTypes, asCopy: false)
	}

	/// Creates and returns a document picker that can open or copy the types of documents you
	/// specify.
	/// - Parameter fileContent: A binding to a property that stores the contents of the selected
	/// file.
	/// - Parameter contentTypes: An array of uniform type identifiers for the document picker to
	...
	public class Coordinator: NSObject, UIDocumentPickerDelegate {
		...
		public func documentPicker(_: UIDocumentPickerViewController,
...
public extension View {
	/// Presents a full-screen document picker that can export or copy the types of documents you
	/// specify when binding to a Boolean value you provide is true.
	/// - Parameters:
	...
	///     For more information, see [Uniform Type
	/// Identifiers](https://developer.apple.com/documentation/uniformtypeidentifiers).
	///   - asCopy: A Boolean value that indicates whether the document picker copies the selected
	/// document.
	///   - allowsMultipleSelection: A Boolean value that determines whether the user can select
	/// more than one document at a time. By default, this property is `false`.
	///   - shouldShowFileExtensions: A Boolean value that determines whether the browser always
	/// shows file extensions.
	///     The default value is `false`. This property has no effect in Mac apps built with Mac
	/// Catalyst.
	///   - directoryURL: The initial directory that the document picker displays.
	///     Set this property to specify the starting directory for the document picker. This
	/// property defaults to `nil`.
	///     If you specify a value, the document picker tries to start at the specified directory.
	///     Otherwise, it starts with the last directory chosen by the user.
	///     The `directoryURL` property only returns a value when you explicitly set it.
	///     For example, it doesn't calculate the default URL presented to the user when the
	/// property isn't set.
	...
	func documentPicker(isPresented: Binding<Bool>,
	                    ...
	                    shouldShowFileExtensions: Bool = false,
	...
	/// Presents a full-screen document picker that can open the types of documents you specify when
