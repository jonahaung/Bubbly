...
struct KeyedViewCacheEnvironmentKey: @preconcurrency EnvironmentKey {
	@MainActor static let defaultValue: KeyedViewCache = InMemoryKeyedViewCache()
}
