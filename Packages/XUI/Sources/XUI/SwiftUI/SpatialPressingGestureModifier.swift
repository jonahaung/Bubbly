...
public struct SpatialPressingGesture: UIGestureRecognizerRepresentable {
	...
	public final class Coordinator: NSObject, UIGestureRecognizerDelegate {
		...
		public func gestureRecognizer(_: UIGestureRecognizer,
		                              shouldBeRequiredToFailBy _: UIGestureRecognizer) -> Bool
		{
			true
		}

		public func gestureRecognizer(_: UIGestureRecognizer,
		                              shouldRequireFailureOf _: UIGestureRecognizer) -> Bool
		{
			false
		}
	}
	...
	public init(coordinateSpace: some CoordinateSpaceProtocol,
	            minimumPressDuration: TimeInterval,
	            allowableMovement: CGFloat,
...
public extension View {
	func onPressingChanged(in coordinateSpace: CoordinateSpaceProtocol,
	                       minimumPressDuration: TimeInterval = 0.5,
	                       allowableMovement: CGFloat = 10,
	                       _ action: @escaping @MainActor (CGPoint?) -> Void) -> some View
	{
		modifier(
