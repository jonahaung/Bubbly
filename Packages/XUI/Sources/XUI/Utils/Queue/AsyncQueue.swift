...
public final class AsyncQueue: @unchecked Sendable {
	...
	private func createTask<Success, Failure>(barrier: Bool,
	...
	private func executeOperation<Success>(props: ExecutionProperties,
...
public extension AsyncQueue {
	...
	@discardableResult
	func addOperation<Success>(priority: TaskPriority? = nil,
	                           barrier: Bool = false,
	                           @_inheritActorContext operation: @escaping ThrowingOperation<
	                           	Success
	                           >)
...
public extension AsyncQueue {
	...
	@discardableResult
	func addBarrierOperation<Success: Sendable>(priority: TaskPriority? = nil,
	                                            @_inheritActorContext operation: @escaping ThrowingOperation<
	                                            	Success
	                                            >) -> Task<Success, Error>
	{
