...
public struct ConversationTheme: Sendable, Equatable, EmptyRepresentable {
    ...
    public static func == (lhs: ConversationTheme, rhs: ConversationTheme) -> Bool {
        lhs.outgoing == rhs.outgoing && lhs.incoming == rhs.incoming && lhs.backgroundColor == rhs.backgroundColor && lhs
            .bubbleCornerRadius == rhs.bubbleCornerRadius && lhs.bubblePading == rhs.bubblePading && lhs.font == rhs.font
    }
